...
Read from the source at 2.0.5. Runtime-tunable values give their environment variable.
...
<sub>NamiDB is developed by NamiDB, Inc. (Delaware, USA) and licensed under the Business Source License 1.1. This report describes version 2.0.5. Corrections and questions: the source is the authority; every claim here is traceable to a file path cited inline.</sub>
