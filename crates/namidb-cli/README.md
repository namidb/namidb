...
`--store <uri>`, it opens a durable namespace on any supported
backend (`file://`, `s3://`, `gs://`, `az://`, `memory://`).
...
The full URI grammar — including endpoint overrides for
R2 / MinIO / LocalStack, GCS service-account paths, and Azure emulator
mode — lives in the [project README](../../README.md#pick-your-storage-backend)
and in [`namidb-storage::uri`](../namidb-storage/src/uri.rs).
